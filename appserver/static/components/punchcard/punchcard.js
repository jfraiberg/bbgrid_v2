define(function(require, exports, module) {
    ...
    var RANGES = {
        ...
        'months_short': moment.monthsShort(),
        'seconds': _.range(0, 60),
        'weekdays': moment.weekdays(),
        'weekdays_short': moment.weekdaysShort()
    };
    var LABEL_WIDTH = 200;
    var MIN_RADIUS = 2;
    var MAX_RADIUS = 15;
    ...
    var PunchcardView = SimpleSplunkView.extend({
        ...
        updateView: function(viz, data) {
            ...
            var xValues = RANGES[this.settings.get('range')] 
                || this.settings.get('range_values')
